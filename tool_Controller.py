...
class initial_tool(QMainWindow):
    def __init__(self,view_trajectory, *args, **kwargs):
        ...
        self.star_simulation=QAction(QIcon('./assets/start.png'), '&start', self)
        self.star_simulation.setIconText("Start Simulation")
        self.star_simulation.triggered.connect(lambda: self.view_trajectory.start_simulation())
    ...
    def create_widgets(self, name,list_widget):
        ...
        self.basicToolBar.addAction(self.star_simulation)            
